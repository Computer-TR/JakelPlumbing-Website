        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center px-4 py-20">
          ...
          >
            ...
            >
              ...
              <p className="text-sm text-gray-500 mb-4 font-medium">Accreditations:</p>
              <div>
                <a 
                  href="https://www.bbb.org/us/wi/abbotsford/profile/plumber/jakel-plumbing-heating-electrical-contractors-inc-0694-14037850/#sealclick" 
                  target="_blank" 
                  rel="nofollow noopener noreferrer"
                  className="h-12 flex items-center inline-flex"
                >
                  <img 
                    src="https://seal-wisconsin.bbb.org/seals/black-seal-200-42-bbb-14037850.png" 
                    alt="Jakel Plumbing, Heating & Electrical Contractors, Inc. BBB Business Review" 
